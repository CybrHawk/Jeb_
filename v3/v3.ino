...
void handleRoot() {
  ...
  <body><div class=\"wrapper\"><ul>\
    <li><p>" + String(batteryPercentage(analogRead(TENSION))) + "</p></li>\
...
int batteryPercentage(int adcValue) {
  ...
  if((voltage <= 4.1) &&  (voltage > 4))
  {
    returnvalue = 90;
  }
  if((voltage <= 4) &&  (voltage > 3.9))
  {
    returnvalue = 80;
  }
  ...
  if((voltage <= 3.8) &&  (voltage > 3.75))
  {
    returnvalue = 60;
  }
  if((voltage <= 3.75) &&  (voltage > 3.7))
  {
    returnvalue = 50;
  }
  if((voltage <= 3.7) &&  (voltage > 3.65))
  {
    returnvalue = 40;
  }
  if((voltage <= 3.65) &&  (voltage > 3.5))
  {
    returnvalue = 30;
  }
  if((voltage <= 3.5) &&  (voltage > 3.1))
  {
    returnvalue = 20;
  }
  if((voltage < 3.1))
