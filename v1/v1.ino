...
void loop()
{
  ...
  if (outputLedState == "off") {
    ...
    if (colorMode == 1 && (currentMillis - oldMillisStatic) > 500){
      ...
      if ((currentMillis - oldMillisDisco) > 10) {
        jeb();
      }
    }
  }
...
void jeb(){
    ...
    //Serial.println("TEST "+String(hue));
...
void handleRoot() {
  ...
  <head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\
    ...
    <style>html { \
      ...
      .wrapper{text-align:center;}.wrapper ul{display:inline-block;margin:0;padding:0;list-style:none;}\
  ...
  <body><div class=\"wrapper\"><ul>\
    <li><form action=\"/brightness/\" method=\"post\" id=\"form\">\
      <h3>Luminosite:<output name=\"LuminosityOutName\" id=\"LuminosityOut\">" + String(brightness) + "</output></p></h3>\
